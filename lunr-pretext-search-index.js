...
},
{
  ...
  "number": "2.1.2",
  "title": "",
  "body": "  Now consider the function .    True or false: slope for means the same thing as it does for in . Be prepared to explain your response.   True    False       True or false: We can find the slope of the line between two points on the same way as we could find the slope of the line between two points on in .   True    False       Find the slope of the line between and . What does the slope of the line you found in part (c) mean for the function?    Assume that gives the distance (in miles) a capybara is from its home tree, hours after a scrumptious nap.   What does mean?   The distance the capybara is from its home tree after hour    The total distance the capybara has traveled after hour    The capybara's velocity (in miles per hour) after hour    Cannot be determined with this information       Use your answer to part (a) to identify what means in context.    In part (c), you found the value of the slope between and . What units should be attached to the slope now?   miles    hours    hours per mile    miles per hour         "
},
{
  "id": "def-aroc",
  "level": "2",
...
},
{
  ...
  "number": "2.1.4",
  "title": "",
  "body": "  Think again about the ball falling in .    Why are we unable to use the average rate of change formula to answer part (d) of ?   We are actually able to use the average rate of change formula, we just didn't use it there.    If we computed it using , we would end up with for the average rate of change.    We don't have specific numbers to put into the formula.    If we computed it using , only the denominator would be , and that makes the fraction undefined.       In and , we talked about limits as a way to approach an input without actually reaching it. Use the ideas from these sections to argue why the expression below solves problem identified in part (a):     True or false: the expressions and compute two different values   True    False   Be prepared to defend your response!   "
},
{
  "id": "def-iroc",
  "level": "2",
...
},
{
  ...
  "number": "2.1.5",
  "title": "",
  "body": "  There is a way to make the definition of instantaneous rate of change match with the expression given in Task (b) of . What is the connection between the two expressions?   "
},
{
  "id": "def-secant-line",
  "level": "2",
  ...
  "number": "2.1.4",
  "title": "Secant Line.",
  "body": " Secant Line   Let be a continuous function on , and let and be inputs in . Then, the secant line secant line between and is the line which goes through the points and    "
},
{
  "id": "def-tangent-line",
  "level": "2",
...
},
{
  ...
  "number": "3.1",
  "title": "",
  "body": "   AD1  I can set up and solve related rates problems.    "
},
{
  "id": "ad-rates-intro1",
  "level": "2",
  "url": "AD1.html#ad-rates-intro1",
  "type": "Activity",
  "number": "3.1.1",
  "title": "",
  "body": "  Consider the equation .    Is this an implicit or explicit equation? Be prepared to defend your answer.   Implicit    Explicit       To find the derivative of both sides of the equation, we think of as a function of , i.e. . Find the derivative, by replacing every instance of with and thinking about the chain rule.    Now think of as a function of , i.e. . Which represents the derivative, ?                          Now reconsider . If both  and are functions of a separate variable , i.e. and , which expression represents ?                         "
},
{
  "id": "ad-rates-implicitfluency1",
  "level": "2",
  "url": "AD1.html#ad-rates-implicitfluency1",
  "type": "Activity",
  "number": "3.1.2",
  "title": "",
...
{
  "id": "ad-rates-practice-walkthrough",
  "level": "2",
  "url": "AD1.html#ad-rates-practice-walkthrough",
  "type": "Activity",
  "number": "3.1.3",
  "title": "",
  "body": "  This problem will introduce related rates problems. Air is being pumped into a spherical balloon so that its volume is increasing at a rate of 100 cm \/s. How fast is the radius of the balloon increasing when the diameter is 50cm?    First we should draw translate the problem from words into pictures and\/or math. Draw two spheres. On the first, include only non-derivative\/non-rate information; on the second, include only derivative\/rate information. Label with appropriate variables.    Which of the following equations seem like they would be useful for the problem? Be ready to defend your answer(s).                          Which equation will allow us to use the rate(s) given in the problem statement?    Take the derivative with respect to . Which is the correctly solved expression for the rate we wish to solve for?                          Which is the correct value of the rate at which the radius is increasing?    cm\/s      cm\/s     cm \/s     cm \/s      "
...
{
  "id": "ad-rates-strategy",
  "level": "2",
  "url": "AD1.html#ad-rates-strategy",
  "type": "Remark",
  "number": "3.1.1",
...
{
  "id": "ad-rates-practice1",
  "level": "2",
  "url": "AD1.html#ad-rates-practice1",
  "type": "Activity",
  "number": "3.1.4",
  "title": "",
...
{
  "id": "ad-rates-practice2",
  "level": "2",
  "url": "AD1.html#ad-rates-practice2",
  "type": "Activity",
  "number": "3.1.5",
  "title": "",
...
{
  "id": "ad-rates-practice3",
  "level": "2",
  "url": "AD1.html#ad-rates-practice3",
  "type": "Activity",
  "number": "3.1.6",
  "title": "",
...
{
  "id": "ad-rates-practice4",
  "level": "2",
  "url": "AD1.html#ad-rates-practice4",
  "type": "Activity",
  "number": "3.1.7",
  "title": "",
...
},
{
  ...
  "number": "3.2",
  "title": "",
  "body": "   AD2  I can find absolute extrema of functions on closed intervals, and find the critical inputs of functions on those intervals.    "
},
{
  "id": "def-global-extrema",
  "level": "2",
  "url": "AD2.html#def-global-extrema",
  "type": "Definition",
  "number": "3.2.1",
...
{
  "id": "ad-activity-extrema1",
  "level": "2",
  "url": "AD2.html#ad-activity-extrema1",
  "type": "Activity",
  "number": "3.2.1",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "AD2.html#thm-extreme-value-theorem",
  "type": "Theorem",
  "number": "3.2.4",
...
{
  "id": "ad-activity-extrema2",
  "level": "2",
  "url": "AD2.html#ad-activity-extrema2",
  "type": "Activity",
  "number": "3.2.2",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "AD2.html#def-critical-point",
  "type": "Definition",
  "number": "3.2.6",
...
{
  "id": "ad-activity-critical1",
  "level": "2",
  "url": "AD2.html#ad-activity-critical1",
  "type": "Activity",
  "number": "3.2.3",
  "title": "",
...
{
  "id": "ad-activity-critical2",
  "level": "2",
  "url": "AD2.html#ad-activity-critical2",
  "type": "Activity",
  "number": "3.2.4",
  "title": "",
...
},
{
  ...
  "number": "3.3",
  "title": "",
  "body": "   AD3  I can determine the qualitative behavior of a function (increasing\/decreasing, concavity, classification of local extrema) using derivative tests.    "
},
{
  "id": "def-local-extrema",
  "level": "2",
  "url": "AD3.html#def-local-extrema",
  "type": "Definition",
  "number": "3.3.1",
...
{
  "id": "ad-activity-extrema-terminology",
  "level": "2",
  "url": "AD3.html#ad-activity-extrema-terminology",
  "type": "Activity",
  "number": "3.3.1",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "AD3.html#def-increasing-decreasing",
  "type": "Definition",
  "number": "3.3.3",
...
{
  "id": "ad-activity-fdt-intuition",
  "level": "2",
  "url": "AD3.html#ad-activity-fdt-intuition",
  "type": "Activity",
  "number": "3.3.2",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "AD3.html#thm-first-derivative-test",
  "type": "Theorem",
  "number": "3.3.4",
...
},
{
  ...
  "level": "2",
  "url": "AD3.html#thm-second-derivative-test",
  "type": "Theorem",
  "number": "3.3.11",
...
{
  "id": "ad-activity-fdtsdt1",
  "level": "2",
  "url": "AD3.html#ad-activity-fdtsdt1",
  "type": "Activity",
  "number": "3.3.5",
  "title": "",
...
{
  "id": "ad-activity-concavity1",
  "level": "2",
  "url": "AD3.html#ad-activity-concavity1",
  "type": "Activity",
  "number": "3.3.6",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "AD3.html#thm-concavity-test",
  "type": "Theorem",
  "number": "3.3.13",
...
},
{
  ...
  "level": "2",
  "url": "AD3.html#def-inflection-point",
  "type": "Definition",
  "number": "3.3.14",
...
{
  "id": "ad-activity-classifypoints1",
  "level": "2",
  "url": "AD3.html#ad-activity-classifypoints1",
  "type": "Activity",
  "number": "3.3.7",
  "title": "",
...
{
  "id": "ad-activity-classifypoints2",
  "level": "2",
  "url": "AD3.html#ad-activity-classifypoints2",
  "type": "Activity",
  "number": "3.3.8",
  "title": "",
...
},
{
  ...
  "number": "3.4",
  "title": "",
  "body": "   AD4  I can set up and solve applied optimization problems.    "
},
{
  "id": "ad-activity-optimization-intuition",
  "level": "2",
  "url": "AD4.html#ad-activity-optimization-intuition",
  "type": "Activity",
  "number": "3.4.1",
  "title": "",
...
{
  "id": "ad-activity-optimization1",
  "level": "2",
  "url": "AD4.html#ad-activity-optimization1",
  "type": "Activity",
  "number": "3.4.2",
  "title": "",
...
{
  "id": "ad-activity-optimization2",
  "level": "2",
  "url": "AD4.html#ad-activity-optimization2",
  "type": "Activity",
  "number": "3.4.3",
  "title": "",
...
{
  "id": "ad-activity-optimization3",
  "level": "2",
  "url": "AD4.html#ad-activity-optimization3",
  "type": "Activity",
  "number": "3.4.4",
  "title": "",
...
{
  "id": "ad-activity-optimization4",
  "level": "2",
  "url": "AD4.html#ad-activity-optimization4",
  "type": "Activity",
  "number": "3.4.5",
  "title": "",
...
{
  "id": "ad-activity-optimization5",
  "level": "2",
  "url": "AD4.html#ad-activity-optimization5",
  "type": "Activity",
  "number": "3.4.6",
  "title": "",
...
{
  "id": "ad-activity-optimization6",
  "level": "2",
  "url": "AD4.html#ad-activity-optimization6",
  "type": "Activity",
  "number": "3.4.7",
  "title": "",
...
},
{
  ...
  "number": "3.5",
  "title": "",
  "body": "   AD5  I can identify and classify indeterminate forms, and compute them using L’Hopital’s Rule or another applicable technique.    "
},
{
  "id": "ad-activity-lhopital-background1",
  "level": "2",
  "url": "AD5.html#ad-activity-lhopital-background1",
  "type": "Activity",
  "number": "3.5.1",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "AD5.html#def-indeterminate-form-division",
  "type": "Definition",
  "number": "3.5.1",
...
{
  "id": "ad-activity-lhopital-identify1",
  "level": "2",
  "url": "AD5.html#ad-activity-lhopital-identify1",
  "type": "Activity",
  "number": "3.5.2",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "AD5.html#thm-lhopitals-rule",
  "type": "Theorem",
  "number": "3.5.3",
...
{
  "id": "ad-activity-lhopital-compute1",
  "level": "2",
  "url": "AD5.html#ad-activity-lhopital-compute1",
  "type": "Activity",
  "number": "3.5.3",
  "title": "",
...
},
{
  ...
  "number": "4.1",
  "title": "",
  "body": "   IN1  I can compute the indefinite integral\/antiderivative of a function using rules and appropriate notation.    "
},
{
  "id": "def-antiderivative",
  "level": "2",
  "url": "IN1.html#def-antiderivative",
  "type": "Definition",
  "number": "4.1.1",
...
{
  "id": "in-activity-antiderivative1",
  "level": "2",
  "url": "IN1.html#in-activity-antiderivative1",
  "type": "Activity",
  "number": "4.1.1",
  "title": "",
...
{
  "id": "in-activity-powerrule",
  "level": "2",
  "url": "IN1.html#in-activity-powerrule",
  "type": "Activity",
  "number": "4.1.2",
  "title": "",
...
{
  "id": "in-activity-antiderivative2",
  "level": "2",
  "url": "IN1.html#in-activity-antiderivative2",
  "type": "Activity",
  "number": "4.1.3",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "IN1.html#table-antiderivatives",
  "type": "Table",
  "number": "4.1.3",
...
{
  "id": "in-activity-antiderivatives3",
  "level": "2",
  "url": "IN1.html#in-activity-antiderivatives3",
  "type": "Activity",
  "number": "4.1.4",
  "title": "",
...
{
  "id": "in-activity-kinematic",
  "level": "2",
  "url": "IN1.html#in-activity-kinematic",
  "type": "Activity",
  "number": "4.1.7",
  "title": "",
...
},
{
  ...
  "number": "4.2",
  "title": "",
  "body": "   IN2  I can compute exact or approximate values for integrals using Riemann sums, properties of definite integrals, the definition of the definite integral, and geometry    "
},
{
  "id": "def-definite-integral-intuitive",
  "level": "2",
  "url": "IN2.html#def-definite-integral-intuitive",
  "type": "Definition",
  "number": "4.2.1",
...
{
  "id": "in-activity-definite-integral-geometry1",
  "level": "2",
  "url": "IN2.html#in-activity-definite-integral-geometry1",
  "type": "Activity",
  "number": "4.2.1",
  "title": "",
...
{
  "id": "in-activity-definite-integral-geometry2",
  "level": "2",
  "url": "IN2.html#in-activity-definite-integral-geometry2",
  "type": "Activity",
  "number": "4.2.2",
  "title": "",
...
{
  "id": "in-activity-riemannsum-intro1",
  "level": "2",
  "url": "IN2.html#in-activity-riemannsum-intro1",
  "type": "Activity",
  "number": "4.2.3",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "IN2.html#def-riemannsum-left-right",
  "type": "Definition",
  "number": "4.2.5",
...
{
  "id": "in-activity-riemannsum-1",
  "level": "2",
  "url": "IN2.html#in-activity-riemannsum-1",
  "type": "Activity",
  "number": "4.2.4",
  "title": "",
...
{
  "id": "in-activity-riemannsum2",
  "level": "2",
  "url": "IN2.html#in-activity-riemannsum2",
  "type": "Activity",
  "number": "4.2.5",
  "title": "",
...
{
  "id": "IN2-activities-10",
  "level": "2",
  "url": "IN2.html#IN2-activities-10",
  "type": "Remark",
  "number": "4.2.7",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "IN2.html#def-definite-integral-limit",
  "type": "Definition",
  "number": "4.2.8",
...
},
{
  ...
  "level": "2",
  "url": "IN2.html#thm-properties-definite-integral",
  "type": "Theorem",
  "number": "4.2.9",
...
{
  "id": "in-activity-definite-properties1",
  "level": "2",
  "url": "IN2.html#in-activity-definite-properties1",
  "type": "Activity",
  "number": "4.2.6",
  "title": "",
  "body": "  If and , what is ?   "
...
{
  "id": "in-activity-definite-compute1",
  "level": "2",
  "url": "IN2.html#in-activity-definite-compute1",
  "type": "Activity",
  "number": "4.2.7",
  "title": "",
...
{
  "id": "in-activity-definite-compute2",
  "level": "2",
  "url": "IN2.html#in-activity-definite-compute2",
  "type": "Activity",
  "number": "4.2.8",
  "title": "",
...
{
  "id": "in-activity-definite-interp1",
  "level": "2",
  "url": "IN2.html#in-activity-definite-interp1",
  "type": "Activity",
  "number": "4.2.9",
  "title": "",
...
{
  "id": "in-activity-definite-interp2",
  "level": "2",
  "url": "IN2.html#in-activity-definite-interp2",
  "type": "Activity",
  "number": "4.2.10",
  "title": "",
...
},
{
  ...
  "number": "4.3",
  "title": "",
  "body": "   IN3  I can use and apply the First and Second Fundamental Theorems of Calculus to compute definite integrals or their derivatives.    "
},
{
  "id": "IN3-activities-2",
  "level": "2",
  "url": "IN3.html#IN3-activities-2",
  "type": "Remark",
  "number": "4.3.1",
  "title": "",
  "body": " In , we established a connection between the definite integral and accumulation of change. The theorem below, the First Fundamental Theorem of Calculus , establishes a link between rates of change (derivatives) and accumulations of change (definite integrals).  "
},
{
  "id": "thm-ftc1",
  "level": "2",
  "url": "IN3.html#thm-ftc1",
  "type": "Theorem",
  "number": "4.3.2",
...
{
  "id": "in-activity-ftc1-intuition1",
  "level": "2",
  "url": "IN3.html#in-activity-ftc1-intuition1",
  "type": "Activity",
  "number": "4.3.1",
  "title": "",
...
{
  "id": "in-activity-ftc1-compute-normal",
  "level": "2",
  "url": "IN3.html#in-activity-ftc1-compute-normal",
  "type": "Activity",
  "number": "4.3.2",
  "title": "",
...
{
  "id": "in-activity-ftc1-compute-chain",
  "level": "2",
  "url": "IN3.html#in-activity-ftc1-compute-chain",
  "type": "Activity",
  "number": "4.3.3",
  "title": "",
...
{
  "id": "in-activity-ftc1-compute1",
  "level": "2",
  "url": "IN3.html#in-activity-ftc1-compute1",
  "type": "Activity",
  "number": "4.3.4",
  "title": "",
...
{
  "id": "in-activity-ftc1-compute2",
  "level": "2",
  "url": "IN3.html#in-activity-ftc1-compute2",
  "type": "Activity",
  "number": "4.3.5",
  "title": "",
...
{
  "id": "IN3-activities-10",
  "level": "2",
  "url": "IN3.html#IN3-activities-10",
  "type": "Remark",
  "number": "4.3.6",
  "title": "",
...
{
  "id": "in-activity-ftc2-1",
  "level": "2",
  "url": "IN3.html#in-activity-ftc2-1",
  "type": "Activity",
  "number": "4.3.6",
  "title": "",
...
{
  "id": "in-activity-ftc2-continuity",
  "level": "2",
  "url": "IN3.html#in-activity-ftc2-continuity",
  "type": "Activity",
  "number": "4.3.7",
  "title": "",
...
{
  "id": "in-activity-ftc2-3",
  "level": "2",
  "url": "IN3.html#in-activity-ftc2-3",
  "type": "Activity",
  "number": "4.3.8",
  "title": "",
...
},
{
  ...
  "number": "4.4",
  "title": "",
  "body": "   IN4  I can use substitution to compute definite or indefinite integrals.    "
},
{
  "id": "in-activity-substitution-intuition",
  "level": "2",
  "url": "IN4.html#in-activity-substitution-intuition",
  "type": "Activity",
  "number": "4.4.1",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "IN4.html#thm-substitution-integrals",
  "type": "Theorem",
  "number": "4.4.1",
...
{
  "id": "in-activity-substitution-practice1",
  "level": "2",
  "url": "IN4.html#in-activity-substitution-practice1",
  "type": "Activity",
  "number": "4.4.2",
  "title": "",
...
{
  "id": "in-activity-substitution-bounds",
  "level": "2",
  "url": "IN4.html#in-activity-substitution-bounds",
  "type": "Activity",
  "number": "4.4.3",
  "title": "",
...
{
  "id": "in-activity-substitution-practice2",
  "level": "2",
  "url": "IN4.html#in-activity-substitution-practice2",
  "type": "Activity",
  "number": "4.4.4",
  "title": "",
...
{
  "id": "in-activity-substitution-practice3",
  "level": "2",
  "url": "IN4.html#in-activity-substitution-practice3",
  "type": "Activity",
  "number": "4.4.5",
  "title": "",
...
},
{
  ...
  "body": " AI3: Volumes by Cylindrical Shells     AI3  I can use the method of cylindrical shells to compute the volume of solids of revolution.      Pre-Class Preparation  Read the following sections of the text:    Section 2.3: Volumes of Revolution: Cylindrical Shells    Read all sections        In-Class Activities    Let ; the graph is sketched below.      A plot of on     Which expression computes the volume of the solid created by rotating the region about the line ?                          When we instead rotate around the line , which of the following describes how the washer should be set up?                  None of the above       The image below shows the region but includes one midpoint rectangle with width .   The graph of on with one midpoint rectangle      When rotated about the line , the rectangle will make a cylindrical shell shape. What is the volume of that shell?                           Shell Method  shell method   Let be a continuous function on the interval . Then, the volume of the solid created by rotating the region bounded and the about the line is given by where is a radius function describing the distance from to the cylinder.      Consider the region bounded by the curve , the axis, and the line .    Sketch and label the region.    Sketch and label a typical approximating cylinder, when rotated about .    Set up and solve an integral to find the volume of the resulting solid.      Use the shell method to find the volume of the solid generated by revolving the region bounded by the curves , , , and about the axis.    Sketch the solid and an approximating cylinder for the solid.    Which integral correctly sets up the shell method in order to find the volume?            Find the volume of the solid created by rotating the first-quadrant region bounded by the curves and about the axis.      Find the volume of the solid created by rotating the region bounded by the curves , , and about .      Find the volume of the solid created by rotating the region bounded by the curves , , and about .     "
},
{
  "id": "AI3-2",
  "level": "2",
...
{
  "id": "ai-shell-intuition",
  "level": "2",
  "url": "AI3.html#ai-shell-intuition",
  "type": "Activity",
  "number": "6.3.1",
  "title": "",
  "body": "  Let ; the graph is sketched below.      A plot of on     Which expression computes the volume of the solid created by rotating the region about the line ?                          When we instead rotate around the line , which of the following describes how the washer should be set up?                  None of the above       The image below shows the region but includes one midpoint rectangle with width .   The graph of on with one midpoint rectangle      When rotated about the line , the rectangle will make a cylindrical shell shape. What is the volume of that shell?                         "
},
{
  "id": "thm-shell-method",
  "level": "2",
  "url": "AI3.html#thm-shell-method",
  "type": "Theorem",
  "number": "6.3.3",
  "title": "Shell Method.",
  "body": " Shell Method  shell method   Let be a continuous function on the interval . Then, the volume of the solid created by rotating the region bounded and the about the line is given by where is a radius function describing the distance from to the cylinder.   "
},
{
  "id": "ai-shell-practice1",
  "level": "2",
  "url": "AI3.html#ai-shell-practice1",
  "type": "Activity",
  "number": "6.3.2",
  "title": "",
  "body": "  Consider the region bounded by the curve , the axis, and the line .    Sketch and label the region.    Sketch and label a typical approximating cylinder, when rotated about .    Set up and solve an integral to find the volume of the resulting solid.   "
},
{
  "id": "ai-shell-practice2",
  "level": "2",
  "url": "AI3.html#ai-shell-practice2",
  "type": "Activity",
  "number": "6.3.3",
  "title": "",
  "body": "  Use the shell method to find the volume of the solid generated by revolving the region bounded by the curves , , , and about the axis.    Sketch the solid and an approximating cylinder for the solid.    Which integral correctly sets up the shell method in order to find the volume?         "
},
{
  "id": "ai-shell-practice3",
  "level": "2",
  "url": "AI3.html#ai-shell-practice3",
  "type": "Activity",
  "number": "6.3.4",
  "title": "",
  "body": "  Find the volume of the solid created by rotating the first-quadrant region bounded by the curves and about the axis.   "
},
{
  "id": "ai-shell-practice4",
  "level": "2",
  "url": "AI3.html#ai-shell-practice4",
  "type": "Activity",
  "number": "6.3.5",
  "title": "",
  "body": "  Find the volume of the solid created by rotating the region bounded by the curves , , and about .   "
},
{
  "id": "ai-shell-practice5",
  "level": "2",
  "url": "AI3.html#ai-shell-practice5",
  "type": "Activity",
  "number": "6.3.6",
  "title": "",
  "body": "  Find the volume of the solid created by rotating the region bounded by the curves , , and about .   "
},
{
  ...
  "body": " AI4: Arc Length & Surface Area     AI4  I can determine the arc length of a curve and the surface area of a solid of revolution.      Pre-Class Preparation  Read the following sections of the text:    Section 2.4: Arc Length of a Curve and Surface Area    Read all sections        In-Class Activities    Suppose we wanted to find the arclength of the parabola over the interval .   Plot of over .   Plot of over .      Suppose we wished to estimate this length with two line segments where .  Plot of over with two line segments where .   Plot of over .    Which of the following expressions represents the sum of the lengths of the line segments with endpoints , and ?        Suppose we wished to estimate this length with four line segments where .  Plot of over with four line segments where .   Plot of over .    Which of the following expressions represents the sum of the lengths of the line segments with endpoints , , , and ?             Suppose we wished to estimate this length with line segments where . Let .  Plot of over with line segments where .   Plot of over .    Which of the following expressions represents the length of the line segment from to ?                Which of the following Riemann sums best estimates the arclength of the parabola over the interval ? Let .                Note that . Which of the following best describes ?     This limit is undefined.      Arc Length  arc length   Given a differentiable function , the arc length of defined on is computed by the integral       Use to find an integral which measures the arc length of the parabola over the interval .      Consider the curve defined on .   Estimate the arc length of this curve with two line segments where .            Length of segment                    Estimate the arc length of this curve with four line segments where .            Length of segment                                    Find an integral which computes the arc length of the curve defined on .     Consider the curve over the interval .   Estimate this arc length with 5 line segments where .  Find an integral which computes this arc length.    "
},
{
  "id": "AI4-2",
  "level": "2",
...
{
  "id": "ai-arclength-intuition",
  "level": "2",
  "url": "AI4.html#ai-arclength-intuition",
  "type": "Activity",
  "number": "6.4.1",
  "title": "",
...
},
{
  "id": "def-arclength",
  "level": "2",
  "url": "AI4.html#def-arclength",
  "type": "Definition",
  "number": "6.4.5",
  "title": "Arc Length.",
  "body": " Arc Length  arc length   Given a differentiable function , the arc length of defined on is computed by the integral    "
},
{
  "id": "ai-arclength-practice1",
  "level": "2",
  "url": "AI4.html#ai-arclength-practice1",
  "type": "Activity",
  "number": "6.4.2",
  "title": "",
  "body": "  Use to find an integral which measures the arc length of the parabola over the interval .   "
},
{
  "id": "ai-arclength-practice2",
  "level": "2",
  "url": "AI4.html#ai-arclength-practice2",
  "type": "Activity",
  "number": "6.4.3",
  "title": "",
  "body": "  Consider the curve defined on .   Estimate the arc length of this curve with two line segments where .            Length of segment                    Estimate the arc length of this curve with four line segments where .            Length of segment                                    Find an integral which computes the arc length of the curve defined on .  "
},
{
  "id": "ai-arclength-practice3",
  "level": "2",
  "url": "AI4.html#ai-arclength-practice3",
  "type": "Activity",
  "number": "6.4.4",
  "title": "",
  "body": "  Consider the curve over the interval .   Estimate this arc length with 5 line segments where .  Find an integral which computes this arc length.  "
},
{
  "id": "TI1",
  "level": "1",
...
{
  "id": "ti-activity-integrationbyparts-intuition",
  "level": "2",
  "url": "TI1.html#ti-activity-integrationbyparts-intuition",
  "type": "Activity",
  "number": "7.1.1",
  "title": "",
...
{
  "id": "ti-activity-integrationbyparts-derive",
  "level": "2",
  "url": "TI1.html#ti-activity-integrationbyparts-derive",
  "type": "Activity",
  "number": "7.1.2",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "TI1.html#thm-integrationbyparts",
  "type": "Theorem",
  "number": "7.1.1",
  "title": "Integration by Parts.",
  "body": " Integration by Parts  integration by parts   By the product rule, and, subsequently, . There is a dual integration technique reversing this process, known as integration by parts .  This technique involves using algebra to rewrite an integral of a product of functions in the form and then using the equality .   "
},
{
  "id": "ti-integrationbyparts-practice1",
  "level": "2",
  "url": "TI1.html#ti-integrationbyparts-practice1",
  "type": "Activity",
  "number": "7.1.3",
  "title": "",
  "body": "  Consider . Suppose we decided to let .   Compute , and rewrite it as .  Which is the best candidate for ?        Use part (b) to find .  Solve , and then give the most general antiderivative of .  "
},
{
  "id": "TI1-activities-6",
  "level": "2",
  "url": "TI1.html#TI1-activities-6",
  "type": "Example",
  "number": "7.1.2",
  "title": "",
...
{
  "id": "ti-integrationbyparts-which1",
  "level": "2",
  "url": "TI1.html#ti-integrationbyparts-which1",
  "type": "Activity",
  "number": "7.1.4",
  "title": "",
...
{
  "id": "ti-integrationbyparts-which2",
  "level": "2",
  "url": "TI1.html#ti-integrationbyparts-which2",
  "type": "Activity",
  "number": "7.1.5",
  "title": "",
...
{
  "id": "ti-integrationbyparts-practice3",
  "level": "2",
  "url": "TI1.html#ti-integrationbyparts-practice3",
  "type": "Activity",
  "number": "7.1.6",
  "title": "",
  "body": "  Consider the integral .    Suppose we proceed using integration by parts. Which of the following candidates for and would best allow you to evaluate this integral?   ,    ,    ,    ,       Evaluate the integral using integration by parts.    Now use integration by parts to evaluate the integral .   "
},
{
  "id": "ti-integrationbyparts-practice4",
  "level": "2",
  "url": "TI1.html#ti-integrationbyparts-practice4",
  "type": "Activity",
  "number": "7.1.7",
  "title": "",
  "body": "  Consider the integral .    Suppose we proceed using integration by parts. Which of the following candidates for and would best allow you to evaluate this integral?   ,    ,    ,    ,       Evaluate the integral using part (a).     "
},
{
  "id": "ti-integrationbyparts-practice5",
  "level": "2",
  "url": "TI1.html#ti-integrationbyparts-practice5",
  "type": "Activity",
  "number": "7.1.8",
  "title": "",
...
{
  "id": "ti-integrationbyparts-practice6",
  "level": "2",
  "url": "TI1.html#ti-integrationbyparts-practice6",
  "type": "Activity",
  "number": "7.1.9",
  "title": "",
...
{
  "id": "ti-integrationbyparts-practice7",
  "level": "2",
  "url": "TI1.html#ti-integrationbyparts-practice7",
  "type": "Activity",
  "number": "7.1.10",
  "title": "",
...
{
  "id": "ti-integrationbyparts-practice8",
  "level": "2",
  "url": "TI1.html#ti-integrationbyparts-practice8",
  "type": "Activity",
  "number": "7.1.11",
  "title": "",
...
{
  "id": "ti-integrationybparts-practice9",
  "level": "2",
  "url": "TI1.html#ti-integrationybparts-practice9",
  "type": "Activity",
  "number": "7.1.12",
  "title": "",
  "body": "  Consider     Use integration by parts to show that     Use part (a) to evaluate    "
},
{
  "id": "TI2",
  "level": "1",
...
},
{
  ...
  "level": "2",
  "url": "MI3.html#MI3-activities-12",
  "type": "Activity",
  "number": "11.3.7",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "MI3.html#MI3-activities-13",
  "type": "Activity",
  "number": "11.3.8",
  "title": "",
...
},
{
  "id": "def-divergence",
  "level": "2",
  "url": "FS1.html#def-divergence",
  "type": "Definition",
  "number": "13.1.1",
  "title": "Divergence.",
  "body": " Divergence  divergence   For a vector field , if each component function is differentiable, the divergence of is given by   In terms of the del operator we can express the divergence of a vector field as   The definition of divergence can be extended to a vector in in the natural way.   "
},
{
  "id": "FS1-activities-3",
  "level": "2",
  "url": "FS1.html#FS1-activities-3",
  "type": "Remark",
  "number": "13.1.2",
  "title": "",
  "body": " Divergence measures the net rate of fluid flow out from a specific point in a vector field; positive divergence means that more fluid flows out than in, and a negative divergence indicates more inflow than outflow.  "
},
{
  "id": "fs-divergence-1",
  "level": "2",
  "url": "FS1.html#fs-divergence-1",
  "type": "Activity",
  "number": "13.1.1",
  "title": "",
...
},
{
  "id": "def-curl",
  "level": "2",
  "url": "FS1.html#def-curl",
  "type": "Definition",
  "number": "13.1.3",
  "title": "Curl.",
  "body": " Curl  curl   For a vector field for which the first partials of each component exists, we define the curl of to be   In terms of the del operator, we can write    "
},
{
  "id": "FS1-activities-7",
  "level": "2",
  "url": "FS1.html#FS1-activities-7",
  "type": "Remark",
  "number": "13.1.4",
  "title": "",
  "body": " Curl represents the tendency of an object to rotate at that point about the axis in the direction of the vector produced; smaller magnitudes of the curl vectors indicate a slower rotation, while larger magnitudes indicate faster rotation.  "
},
{
  "id": "FS1-activities-8",
  "level": "2",
  "url": "FS1.html#FS1-activities-8",
  "type": "Fact",
  "number": "13.1.5",
  "title": "",
  "body": "  The following facts are true about divergence and curl:             If is a vector field defined on a simply connected subset of and , then is conservative.      "
},
{
  "id": "fs-curl-1",
  "level": "2",
  "url": "FS1.html#fs-curl-1",
  "type": "Activity",
  "number": "13.1.3",
  "title": "",
...
},
{
  "id": "fs-curl-3",
  "level": "2",
  "url": "FS1.html#fs-curl-3",
  "type": "Activity",
  "number": "13.1.5",
  "title": "",
  "body": "  The gravitational field between two objects and , has no spin. Prove this fact.   "
},
{
  "id": "fs-div-curl-1",
  "level": "2",
  "url": "FS1.html#fs-div-curl-1",
  "type": "Activity",
  "number": "13.1.6",
  "title": "",
  "body": "  Maxwell's equations relate an electric field and magnetic field as they vary with time in a region which contains no charge and no current. We can state these in terms of divergence and curl as where is the speed of light.  Show the following.             "
},
{
  "id": "FS2",
  "level": "1",
...
},
{
  ...
  "body": " FS4: Stokes' Theorem and the Divergence Theorem     FS4  I can use Stokes’ Theorem and the Divergence Theorem to evaluate various mathematical expressions, and interpret my answers.      Pre-Class Preparation  Read the following sections of the text:    Section 6.7: Stokes' Theorem    Read all sections      Section 6.8: The Divergence Theorem    Read all sections        In-Class Activities   Stokes' Theorem  Stokes' theorem   Let be a piecewise smooth oriented surface with a boundary that is a simple, closed curve with positive orientation. If is a vector field with component functions that have continuous partial derivatives on a open region containing , then      Stokes' Theorem says that the value of a surface integral depends only on the line integral around the boundary only.     Verify Stokes' theorem for the paraboloid and the vector field .           Find the circulation of the field around the curve in which the plane meets the cone , counterclockwise as viewed from above.           Compute the integral , where and is the part of the sphere of radius 2 that lies inside the cylinder and above the plane    0     The Divergence Theorem  divergence theorem   Let be a piecewise, smooth, closed surface that encloses a solid in space. Assume that is oriented outward, and let be a vector field with continuous partial derivatives on an open region containing . Then,       Compute , where is the closed cylinder , , and            Find the flux of outward through the surface of the cube cut from the first octant by the planes .          "
},
{
  "id": "FS4-2",
  "level": "2",
...
},
{
  ...
  "number": "13.4.1",
  "title": "",
  "body": "  Verify Stokes' theorem for the paraboloid and the vector field .   "
},
{
  "id": "fs-stokes-2",
  "level": "2",
